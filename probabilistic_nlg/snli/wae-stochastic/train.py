...
snli_data = utils.get_sentences(file_path='/Users/emielzyde/Downloads/probabilistic_nlg/snli/data/noisy_text.txt')
...
model.train(x_train, x_val) #checkpoint = checkpoint)
